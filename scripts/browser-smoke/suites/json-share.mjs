...
export const description = "Encrypted snapshot share link export and import.";
...
export async function run(ctx) {
  ...
  await withPage(browser, "/", async (page) => {
    ...
    expect(Boolean(snapshotUrl), "Export to link should create a snapshot URL.");
    ...
    try {
      ...
      await waitForText(secondPage.locator(".share-modal"), "Open shared snapshot?");
      await secondPage.getByRole("button", { name: "Replace" }).click();
