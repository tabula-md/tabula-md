...
export async function run(ctx) {
  ...
  await withPage(browser, "/", async (page) => {
    ...
    expect(fileActionContract.copyFileCount === 0, "File rows should keep Copy file inside the more-action menu.");
    expect(fileActionContract.deleteCount === 0, "File rows should keep Delete inside the more-action menu.");
    ...
    expect((await page.getByRole("menuitem", { name: "Copy file" }).count()) === 1, "Right Files menu should expose copy.");
