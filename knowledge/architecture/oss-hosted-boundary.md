...
This keeps the public client repo, separate room relay, encrypted snapshot
store, and official hosted product surface clear. The hosted product can be
easier to use than self-hosting, but the OSS repos should remain coherent and
self-hostable.
