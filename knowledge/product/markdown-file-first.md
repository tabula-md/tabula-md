...
description: Tabula.md should feel like a workspace for Markdown files, comments, and safe sharing.
...
- Keep Markdown files as the primary object.
...
- Treat comments as product comments, not separate notes.
