...
const messages: Record<WorkspaceLanguage, WorkspaceInterfaceMessages> = {
  en: {
    ...
    filesNoneFound: "No documents yet",
    ...
    commentsNoFile: "No document open",
    commentsAs: "as",
  ...
  ja: {
    ...
    commentsNoFile: "ドキュメントが開かれていません",
    commentsAs: "投稿者",
  ...
  es: {
    ...
    filesNoneFound: "Aún no hay documentos",
    ...
    commentsNoFile: "No hay documento abierto",
    commentsAs: "como",
  ...
  fr: {
    ...
    filesNoneFound: "Aucun document pour le moment",
    ...
    commentsNoFile: "Aucun document ouvert",
  ...
  de: {
    ...
    filesNoneFound: "Noch keine Dokumente",
    ...
    commentsNoFile: "Kein Dokument geöffnet",
    commentsAs: "als",
