...
} from "./state/useWorkspaceIdentity";
...
import { getWorkspaceShortcutAction } from "./useWorkspaceKeyboardShortcuts";
import {
...
} from "../comments/commentRuntimeModel";
import {
...
describe("workspace keyboard shortcuts controller", () => {
  ...
  it("maps app-level shortcuts to workspace actions", () => {
    ...
    expect(getWorkspaceShortcutAction(keyEvent({ code: "KeyF", metaKey: true, shiftKey: true, key: "f" }), targetState)).toBe(
      "workspaceSearch",
    );
    expect(
