...
export const deWorkspaceInterfaceMessages = {
    ...
    searchPlaceholder: "Dokumente, Textstellen und Dateien durchsuchen",
    ...
    searchResults: "Workspace-Suchergebnisse",
    searchTypes: "Typen",
    searchTags: "Tags",
    ...
    searchOneDocument: "1 Ergebnis",
    searchDocuments: "{{count}} Ergebnisse",
