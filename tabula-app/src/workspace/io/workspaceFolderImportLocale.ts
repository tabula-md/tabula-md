...
const copies: Record<WorkspaceLanguage, RawWorkspaceFolderImportCopy> = {
  ...
  es: {
    ...
    title: "Importar copia de carpeta",
  ...
  fr: {
    ...
    title: "Importer une copie du dossier",
