...
export type WorkspaceSurfaceCopy = {
  ...
  jsonOpened: string;
  jsonUndo: string;
  jsonSaveFailed: string;
  jsonRestored: string;
  jsonRestoreSaveFailed: string;
...
const surfaceCopy: Record<WorkspaceLanguage, WorkspaceSurfaceCopy> = {
  en: {
    ...
    jsonOpened: "Export copy opened.",
    jsonUndo: "Undo",
    jsonSaveFailed: "The copy opened, but it couldn’t be saved in this browser.",
    jsonRestored: "Previous workspace restored.",
    jsonRestoreSaveFailed: "The previous workspace was restored but couldn’t be saved.",
  ...
  ko: {
    ...
    jsonCancel: "취소",
    jsonOpenCopy: "복사본 열기",
    jsonOpened: "내보내기 복사본을 열었습니다.",
    jsonUndo: "실행 취소",
    jsonSaveFailed: "복사본을 열었지만 이 브라우저에 저장하지 못했습니다.",
    jsonRestored: "이전 워크스페이스를 복원했습니다.",
    jsonRestoreSaveFailed: "이전 워크스페이스를 복원했지만 저장하지 못했습니다.",
    roomExpiredLabel: "만료된 실시간 룸",
    roomExpiredTitle: "이 실시간 룸은 만료되었습니다.",
    roomExpiredDescription: "암호화된 워크스페이스를 더 이상 사용할 수 없습니다.",
    roomUnavailableLabel: "사용할 수 없는 실시간 룸",
    roomUnavailableTitle: "이 실시간 룸을 열 수 없습니다.",
    roomUnavailableDescription: "저장된 워크스페이스가 없고 현재 공유 중인 참여자도 없습니다.",
    openLocalWorkspace: "로컬 워크스페이스 열기",
    roomOpeningLabel: "실시간 룸 여는 중",
    roomOpening: "실시간 룸 여는 중...",
  ...
  ja: {
    ...
    jsonCancel: "キャンセル",
    jsonOpenCopy: "コピーを開く",
    jsonOpened: "書き出しコピーを開きました。",
    jsonUndo: "元に戻す",
    jsonSaveFailed: "コピーを開きましたが、このブラウザーに保存できませんでした。",
    jsonRestored: "以前のワークスペースを復元しました。",
    jsonRestoreSaveFailed: "以前のワークスペースを復元しましたが、保存できませんでした。",
  ...
  zh: {
    ...
    jsonOpened: "已打开导出副本。",
    jsonUndo: "撤销",
    jsonSaveFailed: "副本已打开，但无法保存在此浏览器中。",
    jsonRestored: "已恢复之前的工作区。",
    jsonRestoreSaveFailed: "已恢复之前的工作区，但无法保存。",
  ...
  es: {
    ...
    jsonOpened: "Copia exportada abierta.",
    jsonUndo: "Deshacer",
    jsonSaveFailed: "La copia se abrió, pero no se pudo guardar en este navegador.",
    jsonRestored: "Se restauró el espacio anterior.",
    jsonRestoreSaveFailed: "Se restauró el espacio anterior, pero no se pudo guardar.",
  ...
  fr: {
    ...
    jsonOpened: "Copie exportée ouverte.",
    jsonUndo: "Annuler",
    jsonSaveFailed: "La copie est ouverte, mais n’a pas pu être enregistrée dans ce navigateur.",
    jsonRestored: "L’espace précédent a été restauré.",
    jsonRestoreSaveFailed: "L’espace précédent a été restauré, mais n’a pas pu être enregistré.",
  ...
  de: {
    ...
    jsonOpened: "Exportkopie geöffnet.",
    jsonUndo: "Rückgängig",
    jsonSaveFailed: "Die Kopie wurde geöffnet, konnte aber nicht in diesem Browser gespeichert werden.",
    jsonRestored: "Vorheriger Workspace wiederhergestellt.",
    jsonRestoreSaveFailed: "Der vorherige Workspace wurde wiederhergestellt, konnte aber nicht gespeichert werden.",
