...
const english = {
  ...
  reviewInKnowledge: "Open Metadata",
  documentContext: "Metadata",
  knowledgePassport: "Knowledge passport",
  details: "Details",
  openIssue: "Open in document",
  notConcept: "No structured document properties were found for this file.",
...
const korean: typeof english = {
  ...
  reviewInKnowledge: "메타데이터 열기",
  documentContext: "메타데이터",
  knowledgePassport: "지식 여권",
  details: "세부 정보",
  openIssue: "문서에서 열기",
  notConcept: "이 파일에서 구조화된 문서 속성을 찾지 못했습니다.",
  description: "설명",
  properties: "메타데이터",
  documentProperties: "메타데이터",
  type: "Type",
  status: "상태",
  trust: "신뢰",
  freshness: "최신성",
