...
const copies: Record<WorkspaceLanguage, WorkspaceAssetCopy> = {
  ...
  ja: {
    ...
    previewUnavailableDescription:
      "別のアプリで開くには、このファイルをダウンロードしてください。",
  },
  zh: {
    region: (name) => `${name} 文件`,
    toolbar: "文件工具栏",
  ...
  es: {
    ...
    previewUnavailableDescription:
      "Descarga este archivo para abrirlo en otra aplicación.",
  },
  fr: {
    ...
    previewUnavailableDescription:
      "Téléchargez ce fichier pour l’ouvrir dans une autre application.",
  },
  de: {
    ...
    previewUnavailableDescription:
      "Laden Sie diese Datei herunter, um sie in einer anderen App zu öffnen.",
  },
};
