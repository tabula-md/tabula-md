...
const workspaceMenuCopy: Record<WorkspaceLanguage, WorkspaceMenuCopy> = {
  en: {
    ...
    emptyState: {
      ...
      openWorkspace: "Import folder",
      openWorkspaceDescription: "Import a browser copy of a folder. The original stays separate and does not sync.",
  ...
  ko: {
    ...
    emptyState: {
      ...
      openWorkspace: "폴더 가져오기",
      openWorkspaceDescription: "폴더의 사본을 이 브라우저로 가져옵니다. 원본과 분리되며 동기화되지 않습니다.",
  ...
  ja: {
    ...
    emptyState: {
      ...
      openWorkspace: "フォルダーをインポート",
      openWorkspaceDescription: "フォルダーのコピーをこのブラウザーにインポートします。元のフォルダーとは同期されません。",
  ...
  zh: {
    ...
    emptyState: {
      ...
      openWorkspace: "导入文件夹",
      openWorkspaceDescription: "将文件夹副本导入此浏览器。它与原文件夹分开且不会同步。",
      browseFiles: "浏览项目文件",
      help: "帮助",
    },
    clearWorkspace: {
  ...
  es: {
    actions: {
      ...
      importWorkspace: "Importar carpeta…",
    ...
    emptyState: {
      ...
      openWorkspace: "Importar carpeta",
      openWorkspaceDescription: "Importa una copia de la carpeta en este navegador. El original queda separado y no se sincroniza.",
  ...
  fr: {
    actions: {
      ...
      importWorkspace: "Importer un dossier…",
    ...
    emptyState: {
      ...
      openWorkspace: "Importer un dossier",
      openWorkspaceDescription: "Importez une copie du dossier dans ce navigateur. L’original reste séparé et n’est pas synchronisé.",
  ...
  de: {
    actions: {
      ...
      importWorkspace: "Ordner importieren…",
    ...
    emptyState: {
      ...
      openWorkspace: "Ordner importieren",
      openWorkspaceDescription: "Eine Kopie des Ordners in diesen Browser importieren. Das Original bleibt getrennt und wird nicht synchronisiert.",
