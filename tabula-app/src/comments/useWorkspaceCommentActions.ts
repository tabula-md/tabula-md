...
import type { FileComment, FileBookmark, WorkspaceFile } from "../workspace/workspaceStorage";
import type { WorkspaceActionCopy } from "../workspace/workspaceActionLocale";
